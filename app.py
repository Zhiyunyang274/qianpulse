...
def render_evidence():
    ...
    rows = [
        ...
        ("02", "real", "已完成", "受控物理验证",
         ...
         "/Physical_Validation"),
        ("03", "real", "实测已接入", "车载过桥试点",
         "同一座平桥、10 次真实开车穿越（正向 6 次 / 反向 4 次，iPhone 15 · 100 Hz）。"
         "重力投影提取竖直向加速度，候选峰等权投票融合，主频稳定收敛于 ≈11.9 Hz——多车成脉逻辑在真实道路数据上复现。",
    ...
    chain = [("模拟演示", "已完成", "done"), ("真实 iPhone 采集", "已完成", "done"),
             ("缩尺结构受控实验", "已完成", "done"), ("车载实测", "已完成", "done"),
             ("车队规模验证", "展望", "plan")]
    steps = []
